    ...
    <Popover className="relative">
      {({ open }) => (
        <>
          ...
          >
            <Popover.Panel className="absolute z-10 w-56 p-4 mt-2 text-sm text-black bg-gray-100 border-2 divide-y divide-gray-300 rounded-md shadow-lg shadow-accent dark:text-gray-100 dark:bg-gray-900 border-accent">
        ...
        >
          <Listbox.Options className="absolute w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg max-h-60 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
            <Listbox.Option
              value={"system"}
              className={({ active }) =>
                `${active ? "text-orange-900 bg-amber-100" : "text-gray-900"}
